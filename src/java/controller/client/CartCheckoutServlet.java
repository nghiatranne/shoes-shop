 ...
 * @author phamh
 */
@WebServlet(name="CartCheckoutServlet", urlPatterns={"/cart/infor"})
public class CartCheckoutServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet CartCheckoutServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet CartCheckoutServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        if (session.getAttribute("uName") != null) {
            ...
            if (acc!=null) {
                ...
                Address address = addressDAO.getAddressChoosenByAccID(acc.getId());
