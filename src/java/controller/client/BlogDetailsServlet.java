 ...
 * @author phamh
 */
@WebServlet(name="BlogDetailsServlet", urlPatterns={"/blog/post-details"})
public class BlogDetailsServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        Post postDetail = postDAO.getPost(id);
        request.setAttribute("post", postDetail);
        
        request.getRequestDispatcher("/views/client/BlogDetails.jsp").forward(request, response);
    } 
