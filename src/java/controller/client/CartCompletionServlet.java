 ...
 * @author hoaht
 */
@WebServlet(name="CartCompletionServlet", urlPatterns={"/cart/completion"})
public class CartCompletionServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        request.getRequestDispatcher("/views/client/CartCompletion.jsp").forward(request, response);
    } 
