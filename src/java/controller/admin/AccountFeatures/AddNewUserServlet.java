 ...
 * @author HP
 */
@WebServlet(name = "AddNewUserServlet", urlPatterns = {"/admin/accounts/add"})
public class AddNewUserServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        request.getRequestDispatcher("/views/admin/AddNewUser.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (emails.contains(email)) {
                ...
                int id = accountDAO.addAccount(account, null);
                addressDao.addNewAddress(id, new Address(0, fullName, address, telephone, null, true));

                try {
                    EmailUtility.sendEmail(host, port, user, pass, email, "Account Created", "Your account has been created successfully. Here is your password: " + password);
