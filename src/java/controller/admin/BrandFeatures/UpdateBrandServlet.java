 ...
 * @author hoaht
 */
@WebServlet(name = "UpdateBrandServlet", urlPatterns = {"/admin/brands/edit"})
public class UpdateBrandServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Brand b = brandDAO.getBrandById(Integer.parseInt(id));
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        BrandDAO brandDAO = new BrandDAO();
        Brand b = new Brand(Integer.parseInt(id), name, null, null, null);
        brandDAO.editBrand(b);
