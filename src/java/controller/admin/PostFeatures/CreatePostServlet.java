 ...
 * @author hoaht
 */
@WebServlet(name = "CreatePostServlet", urlPatterns = {"/admin/posts/add"})
@MultipartConfig(
...
public class CreatePostServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String thumbnail_fileName = "img_" + token + ".jpg";
        ...
        Post p = new Post(0, title, thumbnail_fileName, content, true, null, null, account, null);
        PostDAO postDAO = new PostDAO();
        postDAO.createNewPost(p, list_category_choose);
