 ...
 * @author hoaht
 */
@WebServlet(name="UpdateCategoryServlet", urlPatterns={"/admin/categories/edit"})
public class UpdateCategoryServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        Category c = da.getCategoryById(id);
    ...
    throws ServletException, IOException {
        ...
        CategoryDAO da = new CategoryDAO();
        Category c = new Category(Integer.parseInt(id), name, null, null, null, null);
        da.editCategory(c);
