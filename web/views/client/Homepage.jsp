          ...
          <div class="container-small px-xl-0 px-xxl-3">
            <div class="mb-6">
              ...
              <div class="swiper-theme-container products-slider">
                ...
                >
                  <div class="swiper-wrapper">
                    <c:forEach items="${listB}" var="l" varStatus="item">
                      <c:if test="${item.index < 12 && l.status == true}">
                        <div class="swiper-slide">
                          <a
                            href="${pageContext.request.contextPath}/books/book-detail?book_isbn=${l.isbn}"
                          >
                            <div
                            ...
                            >
                              ...
                              src="<c:url
                                value="/resources/book_image/${l.image}"
                              />" alt="" />
                            </div>
                          </a>
                        </div>
            ...
            <div class="mb-6">
              ...
              <div class="swiper-theme-container products-slider">
                ...
                >
                  <div class="swiper-wrapper">
                    <c:forEach items="${listBS}" var="lb" varStatus="item">
                      <c:if test="${item.index < 12 && lb.status == true}">
                        <div class="swiper-slide">
                          <a
                            href="${pageContext.request.contextPath}/books/book-detail?book_isbn=${lb.isbn}"
                          >
                            <div
                              class="card h-100 bg-100 justify-content-center p-1"
                            >
                              <img class="img-thumbnail hover-shadow"
                              src="<c:url
                                value="/resources/book_image/${lb.image}"
                              />" alt="" />
                            </div>
                          </a>
                        </div>
                  ...
                  <div class="swiper-wrapper">
                    ...
                    >
                      <c:if test="${item.index < 12 && gpb.status == true}">
                        <div class="swiper-slide">
                          <a
                            href="${pageContext.request.contextPath}/books/book-detail?book_isbn=${gpb.isbn}"
                          >
                            <div
                              class="card h-100 bg-100 justify-content-center p-1"
                            >
                              <img class="img-thumbnail hover-shadow"
                              src="<c:url
                                value="/resources/book_image/${gpb.image}"
                              />" alt=""/>
                            </div>
                          </a>
                        </div>
