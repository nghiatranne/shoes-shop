                ...
                <div class="row">
                    <div class="col-4">
                        <div class="card border border-2 rounded-3">
                            <div class="card-body">
                                <form id="addNewCategoryForm" method="post" action="${pageContext.request.contextPath}/admin/sizes">
                                    <div class="mb-3">
                                        <label class="form-label" for="categoryIdIn">Size ID </label>
                                        <input class="form-control" disabled id="categoryIdIn" placeholder="Size ID is auto increase" />
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label" for="categoryNameIn">Size Value </label>
                                        <input name="size_value" class="form-control" id="categoryNameIn" type="text" />
                                    </div>
                                ...
                                <div id="categories">
                                    ...
                                    <div class="table-responsive scrollbar mx-n1 px-1" style="height: 65vh">
                                        <table class="table fs--1 mb-0">
                                            <thead>
                                                <tr>
                                                    <th class=" align-middle pe-5" scope="col" style="width:15%; padding-left: 0">SIZE ID</th>
                                                    <th class=" align-middle pe-5 overflow-docs" scope="col" style="width:40%; min-width: 100px">SIZE VALUE</th>
                                            ...
                                            <tbody class="list">
                                                <c:forEach var="sizeEntry" items="${listSize}">
                                                    <c:set var="s" value="${sizeEntry.key}" />
                                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static cursor-pointer" onclick="">
                                                        <td class="category_id align-middle white-space-nowrap pe-5 overflow-docs">
                                                            <a class="d-flex align-items-center text-decoration-none">
                                                                <p class="mb-0 text-1100 fw-bold">${s.id}</p>
                                                            </a>
                                                        </td>
                                                        <td class="category_name align-middle pe-5">
                                                            <p class="mb-0 text-1100 fw-bold">${s.value}</p>
                                                        </td>
                                                        <td class="create_date align-middle white-space-nowrap pe-5">
                                                            <p class="mb-0 text-1100 fw-bold">${s.createDate}</p>
                                                        </td>
                                                        <td class="update_date align-middle white-space-nowrap pe-5">
                                                            <p class="mb-0 text-1100 fw-bold">${s.updateDate}</p>
                                                        </td>
                                                        <td class="total_order align-middle white-space-nowrap fw-bold text-1100">
                                                            ${sizeEntry.value} products 
                                                        </td>
                                                        <td class="align-middle">
                                                            <div class="d-flex justify-content-end">
                                                                <a href="sizes/edit?id=${s.id}" class="btn btn-phoenix-secondary btn-icon fs--2 px-0 ms-3" type="button">
                                                                    <span data-feather="edit"></span>
                                                                </a>
                                                                <button onclick="setDeleteCategory(${s.id})" class="btn btn-phoenix-secondary btn-icon fs--2 text-danger px-0 ms-2" type="button" data-bs-toggle="modal" data-bs-target="#model_delete">
        ...
        <script>
            $(document).ready(function () {
                ...
                fetch('http://localhost:8080/ShoesShop/api/sizes')
                        ...
                        .then(data => {
                            data.forEach((el) => {
                                list_category_name.push(String(el.value));
                            });
                        })
                        .catch(error => {
                            console.log(error);
        ...
        <script>
            const setDeleteCategory = (category_id) => {
                ...
                btn_deleteCategory.click(function () {
                    btn_deleteCategory.attr('href', 'sizes/del?id=' + category_id)
                });
            };
        </script>
    </body>
