                ...
                <div class="row">
                    <div class="col-4">
                        <div class="card border border-2 rounded-3">
                            <div class="card-body">
                                <form id="addNewCategoryForm" method="post" action="${pageContext.request.contextPath}/admin/categories">
                                    <div class="mb-3">
                                        <label class="form-label" for="categoryIdIn">Category ID </label>
                                        <input class="form-control" disabled id="categoryIdIn" placeholder="Category ID is auto increase" />
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label" for="categoryNameIn">Category Name </label>
                                        <input name="category_name" class="form-control" id="categoryNameIn" type="text" />
                                    </div>
                                        ...
                                        <table class="table fs--1 mb-0">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class=" align-middle pe-5 overflow-docs" scope="col" style="width:40%; min-width: 100px">CATEGORY NAME</th>
                                                    ...
                                                    <th class=" align-middle" scope="col" style="width:20%;">TOTAL BOOK</th>
                                                    <th></th>
                                                </tr>
                                            </thead>
                                            <tbody class="list">
                                                <c:forEach var="cateEntry" items="${listCate}">
                                                    <c:set var="l" value="${cateEntry.key}" />
                                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static cursor-pointer" onclick="">
                                                        ...
                                                        <td class="total_order align-middle white-space-nowrap fw-bold text-1100">
                                                            ${cateEntry.value} books 
                                                        </td>
                                                        <td class="align-middle">
                                                            <div class="d-flex justify-content-end">
                                                                <a href="categories/edit?id=${l.id}" class="btn btn-phoenix-secondary btn-icon fs--2 px-0 ms-3" type="button">
        ...
        <script>
            const setDeleteCategory = (category_id) => {
                ...
                btn_deleteCategory.click(function () {
                    btn_deleteCategory.attr('href', 'categories/del?id=' + category_id)
                });
            };
        </script>
    </body>
