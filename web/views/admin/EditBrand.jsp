    ...
    <body>
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="card border border-2 rounded-3">
                            <div class="card-body">
                                <form id="addNewCategoryForm" method="post" action="${pageContext.request.contextPath}/admin/brands/edit">

                                    <div class="mb-3">
                                        <label class="form-label" for="categoryIdIn">Brand ID </label>
                                        <input class="form-control" disabled id="categoryIdIn" value="${brand.id}" />
                                        <input class="d-none" name="brand_id" value="${brand.id}" />
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label" for="categoryNameIn">Brand Name </label>
                                        <input name="brand_name" class="form-control" id="categoryNameIn" type="text" value="${brand.name}" />
                                    </div>
                                    <div class="d-flex justify-content-end">
                                        <a class="btn btn-phoenix-warning me-2" href="${pageContext.request.contextPath}/admin/brands">Cancel</a>
        ...
        <script>
            $(document).ready(function () {
                ...
                fetch('http://localhost:8080/BookShopping/api/brands')
                        .then(res => res.json())
                        .then(data => {
                            data.forEach((el) => {
